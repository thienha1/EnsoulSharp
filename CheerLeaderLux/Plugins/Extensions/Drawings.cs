    ...
    class Drawmethods : Statics
    {
        ...
        static void MiniMapDraw(EventArgs args)
        {
            ...
            if (drawMinimapR && player != null)
                Utility.DrawCircle(ObjectManager.Player.Position, R1.Range, System.Drawing.Color.DeepSkyBlue, 2, 30, true);
        }
        ...
        public static float CalcDamage(AIHeroClient target)
        {
