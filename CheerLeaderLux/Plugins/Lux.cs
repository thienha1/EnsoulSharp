...
namespace CheerleaderLux
{
    ...
    public class Lux : Extensions.Statics
    {
        ...
        public static void OnLoad(EventArgs args)
        {
            ...
            Printmsg("Sucessfully loaded - Patch: " + Game.BuildVersion);
        ...
        private static void SupportMode(Orbwalking.BeforeAttackEventArgs args)
        {
            ...
            {
                if (((AIBaseClient)Orbwalker.GetTarget()).IsMinion) args.Process = false;
            }
        ...
        private static void Tickcount(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs args)
        {
        ...
        public static int PassiveDMG(AIBaseClient target)
        {
        ...
        private static float IgniteKillCheck() //Credits to Justy ~ Note to self: don't forget to give credits.
        {
            ...
            else
            {
                ...
                player.GetSummonerSpellDamage(Attackers[0], Damage.DamageSummonerSpell.Ignite) / 5;
        ...
        public static HitChance PredQ(string name)
        {
            ...
            switch (qpred.Items[qpred.SelectedIndex])
            {
                case "Low":
