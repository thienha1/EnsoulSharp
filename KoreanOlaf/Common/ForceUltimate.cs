namespace KoreanOlaf.Common
{
    using System;

    using KoreanOlaf.Properties;
    ...
    class CommonForceUltimate
    {
        ...
        private bool UltimateUp()
        {
            ...
            if (olafMenu.GetParamBool("koreanolaf.miscmenu.forceultimate")
                && olafOrbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo)
            {
