...
/*
 Copyright 2014 - 2015 EnsoulSharp
 Orbwalking.cs is part of EnsoulSharp.Common.
 
 EnsoulSharp.Common is free software: you can redistribute it and/or modify
 it under the terms of the GNU General Public License as published by
 the Free Software Foundation, either version 3 of the License, or
 (at your option) any later version.
 
 EnsoulSharp.Common is distributed in the hope that it will be useful,
 but WITHOUT ANY WARRANTY; without even the implied warranty of
 MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 GNU General Public License for more details.
 
 You should have received a copy of the GNU General Public License
 along with EnsoulSharp.Common. If not, see <http://www.gnu.org/licenses/>.
*/
...
namespace NechritoRiven
{
    ...
    public static class Orbwalking
    {
        ...
        static Orbwalking()
        {
            ...
            _championName = Player.CharacterName;
            AIBaseClient.OnProcessSpellCast += OnProcessSpell;
            AIBaseClient.OnDoCast += Obj_AI_Base_OnDoCast;
        ...
        public static bool InAutoAttackRange(AttackableUnit target)
        {
            ...
            return
                Vector2.DistanceSquared(
                    (target is AIBaseClient) ? ((AIBaseClient)target).PreviousPosition.To2D() : target.Position.To2D(),
                    Player.PreviousPosition.To2D()) <= myRange * myRange;
        }
        ...
        {
            var playerPosition = Player.PreviousPosition;
        ...
        private static void Obj_AI_Base_OnDoCast(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs args)
        {
            if (sender.IsMe)
            {
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="args">The <see cref="AIBaseClientProcessSpellCastEventArgs"/> instance containing the event data.</param>
        private static void Obj_AI_Base_OnDoCast_Delayed(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs args)
        {
        ...
        public class Orbwalker
        {
            ...
            /// <summary>
            /// Forces the orbwalker to move to that point while orbwalking (Game.CursorPosRaw by default).
            /// </summary>
                    ...
                    ActiveMode == OrbwalkingMode.LastHit)
                {
                        ...
                        ObjectManager.Get<AIMinionClient>()
                            .Where(
                                minion =>
                                    ...
                                    .OrderByDescending(minion => minion.CharacterData.SkinName.Contains("Siege"))
                                    .ThenBy(minion => minion.CharacterData.SkinName.Contains("Super"))
                    ...
                    foreach (var minion in minionList)
                    {
                        ...
                        if (minion.Team != GameObjectTeam.Neutral && (_config.Item("AttackPetsnTraps").GetValue<bool>() &&
                            minion.CharacterData.SkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, _config.Item("AttackWards").GetValue<bool>())))
                        {
                            if (predHealth <= 0)
                            {
                        ...
                        if (minion.Team == GameObjectTeam.Neutral && (_config.Item("AttackBarrel").GetValue<bool>() &&
                            minion.CharacterData.SkinName == "gangplankbarrel" && minion.IsHPBarRendered))
                        {
                            if (minion.Health < 2)
                            {
                                return minion;
                    ...
                    var jminions =
                        ObjectManager.Get<AIMinionClient>()
                            .Where(
                                ...
                                && mob.CharacterData.SkinName != "gangplankbarrel");
                    ...
                    if (!ShouldWait())
                    {
                        ...
                        result = (from minion in
                                      ObjectManager.Get<AIMinionClient>()
                                          ...
                                          (_config.Item("AttackPetsnTraps").GetValue<bool>() && minion.CharacterData.SkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, _config.Item("AttackWards").GetValue<bool>())) &&
                                          minion.CharacterData.SkinName != "gangplankbarrel")
                                  let predHealth =
                                      HealthPrediction.LaneClearHealthPrediction(
                                          minion, (int)((_player.AttackDelay * 1000) * LaneClearWaitTimeMod), FarmDelay)
                                  where
            ...
            private void GameOnOnGameUpdate(EventArgs args)
            {
                try
                {
                    ...
                    Orbwalk(
                        target, (_orbwalkingPoint.To2D().IsValid()) ? _orbwalkingPoint : Game.CursorPosRaw,
