...
namespace HyperCarryNautilus
{
    internal class ConfigMenu : Spells
    {
        ...
        public static void InitializeMenu()
        {
            try
            {
                config = new Menu(ObjectManager.Player.CharacterName, ObjectManager.Player.CharacterName, true);
                ...
                {
                    rBlacklist.AddItem(
                        new MenuItem(enemy.CharacterData.SkinName, enemy.CharacterData.SkinName).SetValue(false));
                }
