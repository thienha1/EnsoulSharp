...
namespace e.Motion_Gangplank
{
    class Config
    {
        ...
        public void Initialize()
        {
            ...
            comboMenu.AddItem(new MenuItem("combo.doublee", "Use Double E Combo").SetValue(false));
            comboMenu.AddItem(new MenuItem("combo.triplee", "Use Triple E Combo").SetValue(true));
            comboMenu.AddItem(new MenuItem("combo.r", "Use R"));
            ...
            miscMenu.AddItem(new MenuItem("misc.additionalServerTick", "Additional Server Tick").SetValue(new Slider(30)));
            miscMenu.AddItem(new MenuItem("misc.enemyReactionTime", "enemy Reaction Time").SetValue(new Slider(150,0,500)));
            miscMenu.AddItem(new MenuItem("misc.additionalReactionTime", "Additional Reaction Time on Direction Change").SetValue(new Slider(50, 0, 200)));
            miscMenu.AddItem(new MenuItem("misc.trye", "Always extend with E").SetValue(true));
            miscMenu.AddItem(new MenuItem("misc.autoE", "Place Barrels automatically").SetValue(true));
