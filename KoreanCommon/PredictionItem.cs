namespace KoreanCommon
{
    ...
    internal class PredictionItem
    {
        ...
        public PredictionItem(AIHeroClient target, Spell predictionSpell, KoreanPredictionTypes type = KoreanPredictionTypes.Slow)
        {
        ...
        private void ProcessPrediction(EventArgs args)
        {
            ...
            if (Target.IsStunned || Target.IsNoRender || Target.IsSuppressed)
            {
                AddImmovable();
            }
