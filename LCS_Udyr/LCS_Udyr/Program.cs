...
namespace LCS_Udyr
{
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("LCS Series: Udyr", "LCS Series: Udyr", true);
            {
                ...
                var comboMenu = new Menu(":: Combo Settings", ":: Combo Settings");
                {
                    ...
                    comboMenu.AddItem(new MenuItem("e.stun", "Force (E)").SetValue(true));
            ...
            Interrupters.OnInterrupter += OnInterrupter;
        }
        ...
        private static void OnGapcloser(ActiveGapcloser cGapcloser)
        {
