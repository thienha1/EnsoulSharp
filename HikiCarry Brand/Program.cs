...
namespace HikiCarry_Brand
{
    static class Program
    {
        ...
        {
            if (Brand.CharacterName != "Brand") return;
        ...
        private static void Clear()
        {
            ...
            {
                var wminion = MinionManager.GetMinions(ObjectManager.Player.PreviousPosition, W.Range, MinionTypes.All, MinionTeam.NotAlly).ToList();
        ...
        {
            if (!Config.Item("e.q.interrupter").GetValue<bool>() || !interrupter.Sender.IsValidTarget()) return;
